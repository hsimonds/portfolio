...
public class PortfolioApplication {
	...
	public CommandLineRunner loadUsers(UserRepository userRepository, ProfileRepository profileRepository, PasswordEncoder encoder) {		
		...
		Profile newProfile2 = new Profile("Jane", "https://github.com/", "https://www.linkedin.com/", "janeDoepersonalWebsite.com", "https://janesStackOverflow.com");
		...
		Project newProject = new Project("Spring Boot Portfolio Application", "https://github.com/hsimonds/portfolio", "https://project1samplewebsite.com", 
		...
		Project newProject2 = new Project("Django Recipe Application", "https://github.com/hsimonds/django-recipes", "https://project2samplewebsite.com", "A recipe application built using Django framework."
		...
		Project newProject3 = new Project("Personal Website", "https://github.com/", "https://project3samplewebsite.com", "Personal website providing details on my development experience and links to my profressional websites", 
				"None", "React", "Node.js");
		
		
		// Create some test projects for first sample user
		Project newProject4 = new Project("Jane's unreal game", "https://github.com/", "https://project4samplewebsite.com", 
				"A platformer build in unreal engine", "Creation of graphic assets", 
						"Unreal", "Unreal, C++");
		Project newProject5 = new Project("Jane's first ruby on rails project", "https://github.com/", "https://project5samplewebsite.com", "ToDo list application built using rails",
				"N/A", "HTML,CSS,Javascript", "Rails,Ruby");
		Project newProject6 = new Project("Jane's rust project", "https://github.com/", "https://project5samplewebsite.com", "Small project to test out the rust programming language.", 
